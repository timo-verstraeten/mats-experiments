...
class Farm(object):
    ...
    def __init__(self, instance_dictionary, turbines, wake):
        ...
        turbine_dict = {}
        for c in list(zip(self.layout_x, self.layout_y, turbines)):
            turbine_dict[Coordinate(c[0], c[1])] = copy.deepcopy(c[2])
