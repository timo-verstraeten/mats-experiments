...
def after_install(options, home_dir, activated=False):
    ...
    reqs = ['Jinja2==2.4', 'Pyevolve==0.6', 'Pygments==1.3.1', 'SetupDocs==1.0.5', 'Sphinx==1.2.2', 'bson==0.3.3', 'cobyla==1.0.2', 'conmin==1.0.2', 'decorator==3.4.0', 'docutils==0.10', 'mock==1.0.1', 'networkx==1.9.1', 'newsumt==1.1.1', 'nose==1.3.3', 'openmdao.examples.bar3simulation==0.13.0', 'openmdao.examples.expected-improvement==0.13.0', 'openmdao.examples.mdao==0.13.0', 'openmdao.examples.metamodel-tutorial==0.13.0', 'openmdao.examples.nozzle-geometry-doe==0.13.0', 'openmdao.examples.simple==0.13.0', 'openmdao.lib==0.13.0', 'openmdao.main==0.13.0', 'openmdao.test==0.13.0', 'openmdao.units==0.13.0', 'openmdao.util==0.13.0', 'pycrypto==2.3', 'pyparsing==1.5.7', 'pytz==2014.4', 'requests==2.2.1', 'slsqp==1.0.2', 'traits==4.3.0', 'zope.interface==3.6.1']
