#ifndef THOMPSON_SAMPLING_POISSON_POLICY_HEADER_FILE
#define THOMPSON_SAMPLING_POISSON_POLICY_HEADER_FILE
 ...
 */
class ThompsonSamplingPoissonPolicy : public AIToolbox::Factored::Bandit::PolicyInterface {
    public:
        /**
         ...
         */
        ThompsonSamplingPoissonPolicy(const AIToolbox::Factored::Action & A, const AIToolbox::Factored::Bandit::QFunction & q, const std::vector<std::vector<unsigned>> & counts);
